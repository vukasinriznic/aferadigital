    ...
    <div className="relative flex flex-1 flex-col overflow-hidden bg-surface">
      ...
      <div className="relative mx-auto flex w-full max-w-xl flex-col px-5 pb-12 pt-10 sm:px-8 sm:pb-16 sm:pt-14">
        <Reveal className="flex flex-col items-center text-center">
          ...
          />
          <h1 className="mt-5 font-sans text-[40px] font-extrabold uppercase leading-none tracking-tight text-foreground sm:text-[56px]">
            Afera
          </h1>
          ...
          <div className="mt-4 flex flex-col gap-3">
            ...
            >
              <Image
                ...
                style={{ height: 52, width: 52, objectPosition: "center 10%" }}
              />
